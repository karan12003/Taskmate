...
function Sidebar() {
    ...
    return (
        <>
            ...
            <div className="sidebar overflow-y-auto fixed flex flex-col gap-2 xl:gap-3 text-[var(--text-color)] w-[15rem] py-6 bg-[var(--primary-color)] min-h-screen z-[45]">
                ...
                <div className="menu">
                    ...
                    <ul className="flex flex-col gap-1 overflow-hidden px-4 xl:pt-1">
